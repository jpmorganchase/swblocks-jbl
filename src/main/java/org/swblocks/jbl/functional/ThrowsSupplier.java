...
/**
 * See docs for {@link java.util.function.Supplier}
 *
 * <p>The main difference between {@link java.util.function.Supplier} and {@link ThrowsSupplier} is that this one can
 * throw an exception
 */
@FunctionalInterface
